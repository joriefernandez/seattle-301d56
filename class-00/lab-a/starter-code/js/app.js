...
function displayPics(){
  ...
  // The previous console.log(rando) statement caused an error since the variable rando was declared using const, which has only local scope. Hence, it is only valid within the code blocks of while in displayPics function.
