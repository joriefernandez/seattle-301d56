...
// It refers to the Student object instance.
// 2. What is "this" when joe.scopeArrow() is invoked?
// It refers to the Window object since it bubbled to the global window object.
// 3. Explain why "this" is different when an arrow function is used.
// This is because we are using this in the arrow function, which does not bind to the Student object, instead to the parent object which is the Window.
